...
public class GameManager extends java.lang.Object {
	...
	public void run() {
		...
		if(this.isAllCatch == false) {
			System.out.printf("\n%s실패..%s\n노력해주셔서 감사합니다.", Config.RED, Config.RESET);
			catList.printCatchList();
		}
		...
		System.out.printf("%s플레이 시간 : %02d시간 %02d분 %02d초%s", Config.RED, hours, minutes, seconds, Config.RESET);
	...
	private void showWelcomeStart() {
		...
		System.out.println("2. 츄르는 단 1개만 사용할 수 있습니다. 신중하게 사용하세요.");
